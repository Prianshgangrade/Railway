        ...
        <div>
          <div className="flex justify-between items-center mt-0.5 gap-2">
            ...
            <div className="flex flex-shrink-0 gap-1">
              <button onClick={() => onDepartTrain?.(trackData.id)} className="bg-blue-600 text-white text-xs font-bold py-0.5 px-2 rounded-md hover:bg-blue-700 transition-all">Depart</button>
              <button onClick={() => onUnassignPlatform(trackData.id, trainDetails)} className="bg-red-500 text-white text-xs font-bold py-0.5 px-2 rounded-md hover:bg-red-600 transition-all">Unassign</button>
            </div>
          </div>
          {actualArrival && (
