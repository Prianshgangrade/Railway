      ...
      {isOccupied && trainDetails ? (
        <div>
          <div className="flex justify-between items-center mt-1">
            ...
            <button onClick={() => onUnassignPlatform(platformData.id, trainDetails)} className="bg-red-500 text-white text-xs font-bold py-1 px-3 rounded-md hover:bg-red-600 transition-all flex-shrink-0">Unassign</button>
          </div>
          {actualArrival && (
